const CACHE_NAME = "garage-stock-v3-13-1-migration-test-jwt-15-2";
...
const ASSETS = [
  ...
  "./style.css?v=15.2",
  "./js/core.js?v=15.2",
  "./js/inventory.js?v=15.2",
  "./js/sales-dashboard.js?v=15.2",
  "./js/staff.js?v=15.2",
  "./js/sales.js?v=15.2",
  "./js/requests.js?v=15.2",
  "./js/surveys.js?v=15.2",
  "./js/management.js?v=15.2",
  "./js/purchasing.js?v=15.2",
  "./js/navigation.js?v=15.2",
  "./js/reports.js?v=15.2",
  "./js/migration-api.js?v=15.2",
  "./js/events.js?v=15.2",
  "./js/excel.js?v=15.2",
  "./js/migration-excel.js?v=15.2",
  "./app.js?v=15.2",
  "./manifest.webmanifest?v=15.2",
  "./icons/icon-192.png",
  "./icons/icon-512.png",
