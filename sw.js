const CACHE_NAME = "garage-stock-v3-13-1-migration-test-jwt-14-2";
...
const ASSETS = [
  ...
  "./js/management.js",
  "./js/purchasing.js",
  "./js/navigation.js?v=14.2",
  "./js/reports.js",
  "./js/migration-api.js?v=14.2",
  "./js/events.js?v=14.2",
  "./js/excel.js?v=14.2",
  "./js/migration-excel.js?v=14.2",
  "./app.js?v=14.2",
  "./manifest.webmanifest?v=14.2",
  "./icons/icon-192.png",
  "./icons/icon-512.png",
